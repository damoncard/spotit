...
const symbol =
	{
		ace: 'static/pic/acecard.png',
		acorn: 'static/pic/acorn.png',
		badge: 'static/pic/badge.png',
		balloon: 'static/pic/hotairballoon.png',
		banana: 'static/pic/banana.png',
		bat: 'static/pic/bat.png',
		binky: 'static/pic/binky.png',
		boomerang: 'static/pic/boomerang.png',
		butterfly: 'static/pic/butterfly.png',
		camera: 'static/pic/camera.png',
		can: 'static/pic/wateringcan.png',
		clip: 'static/pic/paperclip.png',
		comb: 'static/pic/comb.png',
		cupcake: 'static/pic/cupcake.png',
		diamond: 'static/pic/diamond.png',
		duck: 'static/pic/rubberduck.png',
		dumbbell: 'static/pic/dumbbell.png',
		dynamite: 'static/pic/dynamite.png',
		fork: 'static/pic/fork.png',
		gnome: 'static/pic/gnome.png',
		go: 'static/pic/go.png',
		hammer: 'static/pic/hammer.png',
		hand: 'static/pic/spotithand.png',
		headphone: 'static/pic/headphone.png',
		highheel: 'static/pic/highheel.png',
		horseshoe: 'static/pic/horseshoe.png',
		hourglass: 'static/pic/hourglass.png',
		hydrant: 'static/pic/firehydrant.png',
		jack: 'static/pic/jackinthebox.png',
		jet: 'static/pic/plane.png',
		lighthouse: 'static/pic/lighthouse.png',
		lollipop: 'static/pic/lollipop.png',
		magnet: 'static/pic/magnet.png',
		oops: 'static/pic/oops.png',
		owl: 'static/pic/owl.png',
		paintbrush: 'static/pic/paintbrush.png',
		pig: 'static/pic/pig.png',
		pin: 'static/pic/bowlingpin.png',
		planet: 'static/pic/planet.png',
		plunger: 'static/pic/plunger.png',
		potato: 'static/pic/potato.png',
		pumpkin: 'static/pic/pumpkin.png',
		racecar: 'static/pic/racecar.png',
		rocket: 'static/pic/rocket.png',
		sandal: 'static/pic/sandal.png',
		scooter: 'static/pic/scooter.png',
		scorpion: 'static/pic/scorpion.png',
		snail: 'static/pic/snail.png',
		starfish: 'static/pic/starfish.png',
		tomato: 'static/pic/tomato.png',
		toothbrush: 'static/pic/toothbrush.png',
		tower: 'static/pic/tower.png',
		trumpet: 'static/pic/trumpet.png',
		watermelon: 'static/pic/watermelon.png',
		wheel: 'static/pic/wheel.png',
		well: 'static/pic/well.png',
		yay: 'static/pic/yay.png'
	}
